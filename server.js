    ...
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            const effects = [
                ...
                // Fade-in and Fade-out Effect (Smooth transitions)
