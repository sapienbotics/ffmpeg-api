...
app.post('/apply-subtitles', async (req, res) => {
    try {
        ...
        // If subtitles are disabled, skip subtitle processing and return the original video
        ...
        // Step 4: Use FFmpeg to add subtitles to the video
        ffmpeg(downloadPath)
            .outputOptions([
